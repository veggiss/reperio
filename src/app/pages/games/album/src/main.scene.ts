...
import {getAlbumImage, correctDifficulty, difficulty} from '../../../../services/globals';

export class MainScene extends Phaser.Scene {
  private bgSprite: Phaser.GameObjects.TileSprite;
  private book: Book;
  private roundData: any = getAlbumImage('', [], difficulty, 1); 
  ...
  preload() {
    ...
    this.load.image('test_image', 'assets/img/games/images/album/' + this.roundData[0].src);
  ...
  create () {
      ...
      this.book = new Book({scene: this, data: this.roundData[0]});
  }
