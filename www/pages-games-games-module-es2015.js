...
let GamesPage = class GamesPage {
    constructor() {
        this.games = {
            lese: _services_globals__WEBPACK_IMPORTED_MODULE_2__["GAMES_LIST"].filter(e => e.category == 1),
            skrive: _services_globals__WEBPACK_IMPORTED_MODULE_2__["GAMES_LIST"].filter(e => e.category == 2),
            lytte: _services_globals__WEBPACK_IMPORTED_MODULE_2__["GAMES_LIST"].filter(e => e.category == 3),
            hjernetrim: _services_globals__WEBPACK_IMPORTED_MODULE_2__["GAMES_LIST"].filter(e => e.category == 4)
        };
    }
};
...
//# sourceMappingURL=pages-games-games-module-es2015.js.map