...
let XpBarComponent = class XpBarComponent {
    constructor() { }
    ngOnInit() { }
};
...
let XpBarModule = class XpBarModule {
};
...
let HomePage = class HomePage {
    constructor() {
        this.favorites = _services_globals__WEBPACK_IMPORTED_MODULE_2__["GAMES_LIST"].filter(e => _services_globals__WEBPACK_IMPORTED_MODULE_2__["favorites"].includes(e.id));
    }
};
