...
var GameInfoPageModule = /** @class */ (function () {
    function GameInfoPageModule() {
    }
...
var GameInfoPage = /** @class */ (function () {
    function GameInfoPage(route, router) {
        var _this = this;
        this.route = route;
        this.router = router;
        this.route.params.subscribe(function (params) {
            var game = Object(_services_globals__WEBPACK_IMPORTED_MODULE_3__["getGame"])(parseInt(params['id']));
            if (!game.length) {
    ...
    GameInfoPage.prototype.ngOnInit = function () {
        console.log(this.item);
    };
    GameInfoPage.prototype.go = function () {
        this.router.navigate(['match']);
    };
    GameInfoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-game-info-game-info-module-es5.js.map